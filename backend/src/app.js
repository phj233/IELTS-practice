...
function createApp(options = {}) {
    ...
    const generatedQuestionBankOptions = {
        ...staticOptions,
        maxAge: 0,
        setHeaders(res) {
            res.set('Cache-Control', 'no-store');
    ...
    const generatedQuestionBankRoot = path.join(repoRoot, 'assets', 'generated');
    app.use('/assets/generated', createStaticBoundary(generatedQuestionBankRoot), express.static(generatedQuestionBankRoot, generatedQuestionBankOptions));
